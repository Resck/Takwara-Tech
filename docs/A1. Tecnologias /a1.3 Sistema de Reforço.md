...
<div class="carousel-container">
  <h4 class="carousel-title">Conexões para Estruturas</h4>
  <div id="carrossel-conexes-varanda" class="splide">
    <div class="splide__track">
      <ul class="splide__list">
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0779.jpg" alt="Dsc 0779">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0781.jpg" alt="Dsc 0781">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0786.jpg" alt="Dsc 0786">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0802.jpg" alt="Dsc 0802">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0804.jpg" alt="Dsc 0804">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0805.jpg" alt="Dsc 0805">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0807.jpg" alt="Dsc 0807">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0811.jpg" alt="Dsc 0811">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0838.jpg" alt="Dsc 0838">
        </li>
        <li class="splide__slide">
          <img src="../../assets/images/carrosseis-otimizados/conexões-varanda/dsc-0844.jpg" alt="Dsc 0844">
        </li>
      </ul>
    </div>
  </div>
...
<div class="carousel-container">
  <h4 class="carousel-title">Cabos para Ferramentas</h4>
